...
def analyze_email(
    ...
    return {
        ...
        "summary": {
            ...
            "verdict_label": scored.get("verdict_label", "Needs Review Before Send"),
            "real_world_risk": scored.get("real_world_risk", "Unknown (reputation and engagement signals are not analyzed)"),
